...
class Level_1(Widget) :
    pass

class Background_Bonus_1(Widget):
    pass


class Pushup_1(Widget):
    upup = bool
...
class Pausebutt_1(Button):
    pause = False

    def on_press(self):
        self.pause = not self.pause
        
class Resumebutt_1(Button):
    resume = True
    def on_press(self):
        self.resume = not self.resume

class Clickbutt_1(Button):
    move_up = True
    tell = True
